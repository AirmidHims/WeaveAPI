...
namespace HIMS.API.Controllers.Transaction
{
    ...
    public class InPatientController : Controller
    {
        ...
        public readonly I_Prepostopnote _Prepostopnote;
         public readonly I_Doctorsharemaster _Doctorsharemaster;
        ...
        public InPatientController(I_AdmissionReg admission,
            ...
            I_Doctorsharemaster doctorsharemaster
            //I_Customer_complaint customer_Complaint
            )
        {
            ...
            this._Doctorsharemaster = doctorsharemaster;
      ...
      /*  Mycomment
       ...
       /*mycomment [HttpPost("IPAdvance")]
        ...
        [HttpPost("DoctorShareInsert")]
        public IActionResult DoctorShareInsert(Doctorsharemasterparam Doctorsharemasterparam)
        {
            var RPAP = _Doctorsharemaster.Insert(Doctorsharemasterparam);
            return Ok(RPAP);
        }
        Mycomment*/
        /*  [HttpPost("CustomercomplaintInsert")]
          public IActionResult CustomercomplaintInsert(Customercomplaintparam Customercomplaintparam)
          {
              var OtId = _Customer_Complaint.Insert(Customercomplaintparam);
              return Ok(OtId);
          }
