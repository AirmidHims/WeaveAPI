    ...
    public static class ServiceExtension
    {
        ...
        public static void AddMyDependancies(this IServiceCollection services, IConfiguration configuration)
        {
          ...
          //  services.AddTransient<I_BankMaster, R_BankMaster>();
            ...
            services.AddTransient<I_Doctorsharemaster, R_Doctorsharemaster>();
            services.AddTransient<I_Workorder, R_Workorder>();


            services.AddTransient<I_YarnMaster, R_YarnMaster>();
            services.AddTransient<I_Shademaster, R_Shademaster>();
            services.AddTransient<I_MillMaster, R_MillMaster>();
            services.AddTransient<I_WeaveItemmaster, R_WeaveItemmaster>();
            services.AddTransient<I_INVAddlessmaster, R_INVAddlessmaster>();
            services.AddTransient<I_INVQualitymaster, R_INVQualitymaster>();
            ...
            services.AddTransient<I_RollTypemaster, R_RollTypemaster>();
            services.AddTransient<I_LoomTypemaster, R_LoomTypemaster>();
            services.AddTransient<I_PartyAccount, R_PartyAccount>();
            services.AddTransient<I_ContractBooking, R_ContractBooking>();
        ...
        public static void AddMySwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Weaver Project V1",
                    Description = "Weaver Project"
                });
